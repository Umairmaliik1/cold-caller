...
def load_contacts(file_path):
    ...
    with open(file_path, newline='') as csvfile:
        ...
        for row in reader:
            contacts.append({"name": row["name"], "phone": row["phone_number"]})
    return contacts
...
class OutboundCaller(Agent):
    def __init__(
        ...
        *,
        ...
        super().__init__(
            instructions=f"""
            You are a representative from mindrind. If user ask about mindrind then tell the user that
            mindrind is a software that provide software related services.
            """
        )
    ...
    @function_tool()
    async def save_info(self,ctx:RunContext,name,phone):
        """Called when the user has provided all the details. Use this tool to save data in a csv.
        Args:
        name: Name of the user.(String)
        phone: Phone number of the user.(string)
        """
        
        with open("cold-caller/user_data.csv", "a", newline='') as csvfile:
